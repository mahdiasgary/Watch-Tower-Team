...
def upsert_http(subdomain, scope,providers, ips, tech, title, status_code, headers, url, final_url, favicon):
    ...
    if existing:
        ...
        if existing.title != title:
            ...
            send_discord_message(subdomain, program.program_name, "http_title", [str(existing.title), str(title)])
        ...
        if existing.status_code != status_code:
            ...
            send_discord_message(subdomain, program.program_name, "http_status_code", [existing.status_code, status_code])
        ...
        if existing.favicon != favicon:
            ...
            send_discord_message(subdomain, program.program_name, "http_favicon", [existing.favicon, favicon])
        ...
        send_discord_message(subdomain, program.program_name, "http_fresh", status_code)
